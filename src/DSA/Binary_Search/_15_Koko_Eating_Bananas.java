...
//Problem Statement = Return the minimum integer k such
...
public class _15_Koko_Eating_Bananas {
    ...
    public int minEatingSpeed(int[] piles, int h) {
        ...
        while (low <= high) {
            ...
            //If the time taken to eat the bananas is less than
            //the maximum time given then check for the lesser numbers.
            //So go back.
